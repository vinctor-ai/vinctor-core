...
class AgentEnforcementSettingsRepository(Protocol):
    # get_require_boundary is the EFFECTIVE value (agent override → workspace
    # override → schema default) and must agree with is_boundary_required.
    # get_require_boundary_setting is the raw override at one scope, or None.
