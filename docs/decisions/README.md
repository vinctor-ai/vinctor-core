...
- `0021-asymmetric-sender-constrained-pop.md`
- `0022-idempotency-result-encryption.md` — encrypted seven-route retry results,
  external key custody, durable nonce accounting, and explicit key lifecycle barriers
