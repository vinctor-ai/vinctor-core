...
from vinctor_core.audit import REASON_POP_PROOF_INVALID
...
def test_pop_token_without_proof_denies() -> None:
    ...
    assert audit.events[-1].reason_code == REASON_POP_PROOF_INVALID
...
def test_pop_verification_exception_is_generic_subject_token_invalid(
    ...
    assert svc.audit_events[-1].reason_code == REASON_POP_PROOF_INVALID
